...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._off_range = Range(0, 50, 0.1, .1, 200)
        self._off_win = RangeWidget(self._off_range, self.set_off, "off", "counter_slider", float)
        self.top_grid_layout.addWidget(self._off_win)
        ...
        self.blocks_multiply_const_vxx_3 = blocks.multiply_const_vff((500, ))
        self.blocks_multiply_const_vxx_2 = blocks.multiply_const_vff((1.414, ))
        self.blocks_multiply_const_vxx_1 = blocks.multiply_const_vff((0.1, ))
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_vff((1.414, ))
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_SIN_WAVE, off, 1, 0)
        ...
        self.connect((self.blocks_multiply_const_vxx_1, 0), (self.blocks_udp_sink_0, 0))
        self.connect((self.blocks_multiply_const_vxx_2, 0), (self.blocks_sub_xx_0, 0))
        self.connect((self.blocks_multiply_const_vxx_3, 0), (self.iir_filter_xxx_1, 0))
        ...
        self.connect((self.blocks_multiply_xx_1_0, 0), (self.blocks_multiply_const_vxx_0, 0))
        ...
        self.connect((self.blocks_vco_c_0, 0), (self.rational_resampler_xxx_0, 0))
        ...
        self.connect((self.iir_filter_xxx_0, 0), (self.blocks_multiply_const_vxx_1, 0))
        ...
        self.connect((self.rational_resampler_xxx_0, 0), (self.blocks_multiply_xx_2, 1))
    ...
    def set_off(self, off):
        self.off = off
        self.analog_sig_source_x_0.set_frequency(self.off)
