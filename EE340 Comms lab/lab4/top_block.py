...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_multiply_const_vxx_1_0 = blocks.multiply_const_vff((amplitude, ))
        self.blocks_multiply_const_vxx_1 = blocks.multiply_const_vff((1, ))
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_float*1, 'D:\\Iitb\\Sem6\\communications lab\\lab4\\Input.bin', True)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_add_xx_0 = blocks.add_vff(1)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 50000, 1, 0)
    ...
    def set_amplitude(self, amplitude):
        ...
        self.blocks_multiply_const_vxx_1_0.set_k((self.amplitude, ))
