...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.samp_rate = samp_rate = 32000*factor
        ...
        self.tab_grid_layout_1.addWidget(self._qtgui_time_sink_x_0_0_win)
        ...
        self.tab_grid_layout_1.addWidget(self._qtgui_freq_sink_x_0_1_win)
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(1, firdes.low_pass(
        	10, samp_rate, 15000, 5000, firdes.WIN_HAMMING, 6.76))
        self.hilbert_fc_0 = filter.hilbert_fc(65, firdes.WIN_HAMMING, 6.76)
        self.dc_blocker_xx_0 = filter.dc_blocker_ff(32, True)
        self.blocks_wavfile_source_0 = blocks.wavfile_source('D:\\Iitb\\Sem6\\communications lab\\Lab1\\vocal.wav', True)
        ...
        self.analog_sig_source_x_2 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 5000*factor, 1, 0)
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 5000*factor, 1, 0)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_sig_source_x_1, 0), (self.blocks_multiply_xx_2, 0))
        ...
        self.connect((self.blocks_complex_to_real_1, 0), (self.blocks_multiply_xx_2, 1))
        self.connect((self.blocks_complex_to_real_1, 0), (self.blocks_throttle_0, 0))
        self.connect((self.blocks_conjugate_cc_0, 0), (self.rational_resampler_xxx_0_0, 0))
        ...
        self.connect((self.blocks_throttle_0_1, 0), (self.qtgui_time_sink_x_0_0, 0))
        self.connect((self.blocks_throttle_0_1, 0), (self.rational_resampler_xxx_1, 0))
        self.connect((self.blocks_wavfile_source_0, 0), (self.hilbert_fc_0, 0))
        self.connect((self.dc_blocker_xx_0, 0), (self.blocks_throttle_0_1, 0))
    ...
    def set_factor(self, factor):
        self.factor = factor
        self.set_samp_rate(32000*self.factor)
        self.analog_sig_source_x_2.set_frequency(5000*self.factor)
        self.analog_sig_source_x_1.set_frequency(5000*self.factor)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(10, self.samp_rate, 15000, 5000, firdes.WIN_HAMMING, 6.76))
